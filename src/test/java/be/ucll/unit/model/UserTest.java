...
public class UserTest {
    ...
    @Test
    public void givenExistingUnderageUser_whenSettingProfile_thenRuntimeExceptionIsThrown() {
        User user = new User("John Doe", 14, "john.doe@ucll.be", "password123");

        Exception ex = Assertions.assertThrows(RuntimeException.class,
                () -> user.setProfile(new Profile("x", "x", "x")));
